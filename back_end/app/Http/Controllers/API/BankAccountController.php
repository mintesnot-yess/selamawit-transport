...
class BankAccountController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        log_action('Created ' . class_basename($bankAccount) . ' #' . $bankAccount->id);
    ...
    public function destroy($id)
    {
        ...
        $bankAccount->delete();
        log_action('Deleted ' . class_basename($bankAccount) . ' #' . $bankAccount->id);
        return response()->json([
    ...
    public function update(Request $request, $id)
    {
        ...
        log_action('Updated ' . class_basename($bankAccount) . ' #' . $bankAccount->id);
    ...
    public function search(Request $request, $id)
    {
        ...
        $bankAccounts = $query->orderBy('created_at', 'desc')->get()->map(function ($account) {
            return [
                'id' => $account->id,
                'account_number' => $account->account_number,
                'bank' => [
