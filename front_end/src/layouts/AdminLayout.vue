<template>
    ...
    <div class="flex-1 flex flex-col">
        ...
        <main class="p-4 md:p-6 space-y-6 overflow-scroll">
            <!-- Welcome banner -->
            <div
                class="bg-gradient-to-r from-accent-600 to-accent-500 rounded-xl p-6 text-white"
            >
                <div
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div
                    class="bg-white rounded-xl p-5 shadow-sm border border-surface-200"
                >
                    ...
                    <div class="mt-4">
                        <div
                            class="h-2 bg-surface-100 rounded-full overflow-hidden"
                        >
                            <div
                ...
                >
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            >
                                <i
                                    class="fas fa-shopping-bag text-blue-600"
                                ></i>
                            </div>
                            <div>
                                <p class="text-xs text-surface-500">
                ...
                >
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            >
                                <i
                                    class="fas fa-shopping-bag text-purple-600"
                                ></i>
                            </div>
                            <div>
                                <p class="text-xs text-surface-500">
                ...
                >
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            >
                                <i
                                    class="fas fa-arrow-trend-up text-purple-600"
                                ></i>
                            </div>
                            <div>
                                <p class="text-xs text-surface-500">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <!-- Sales chart -->
                <div
                    class="bg-white rounded-xl p-6 shadow-sm border border-surface-200 lg:col-span-2"
                >
                    <div
                ...
                <!-- Revenue target -->
                <div
                    class="bg-white rounded-xl p-6 shadow-sm border border-surface-200"
                >
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-surface-200">
                        ...
                        <tbody class="bg-white divide-y divide-surface-200">
                            <tr>
                                <td
                                    class="px-6 py-4 whitespace-nowrap text-sm font-medium text-surface-900"
                                >
                                    #ORD-0001
                                </td>
                                ...
                                <td
                                    class="px-6 py-4 whitespace-nowrap text-sm text-surface-500"
                                >
                                    3-A12797/33595
                                </td>
                                <td
                                ...
                                <td
                                    class="px-6 py-4 whitespace-nowrap text-sm text-surface-900"
                                >
                                    $249.00
                                </td>
