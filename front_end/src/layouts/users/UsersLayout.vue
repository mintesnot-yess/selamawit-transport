    ...
    <div class="flex-1 flex flex-col">
        ...
        <header
            ...
            <div class="flex items-center gap-3">
                <form @input.prevent="searchUsers(searchQuery)"
        ...
        <main class="p-4 md:p-6 space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            ...
                            <p class="text-sm text-surface-500">
                                ...
                                <template v-else-if="searchError" class="text-red-500">{{
                                    searchError
                                    }}</template>
                                <template v-else>
            ...
            <div id="side_form_container" class="side-form" :class="{ hidden: !isSideFormVisible }">
                <div
                    ...
                    <button aria-label="Close" @click="toggleAddUserForm"
                    ...
                    <div @click="toggleAddUserForm" id="side_form"
                    ...
                    <div id="side_form" class="md:max-w-md p-6 w-full h-full bg-white rounded-xl">
                        ...
                        <form @submit.prevent="handleSubmit" class="flex flex-col space-y-6 js font-['Inter']">
                            ...
                            <!-- Password fields (only shown when adding new user) -->
